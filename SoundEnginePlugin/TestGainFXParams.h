...
#ifndef TestGainFXParams_H
#define TestGainFXParams_H
...
struct TestGainRTPCParams
{
    AkReal32 fPlaceholder;
};

struct TestGainNonRTPCParams
{
};

struct TestGainFXParams
    : public AK::IAkPluginParam
{
    TestGainFXParams();
    TestGainFXParams(const TestGainFXParams& in_rParams);
    ...
    TestGainRTPCParams RTPC;
    TestGainNonRTPCParams NonRTPC;
};

#endif // TestGainFXParams_H
